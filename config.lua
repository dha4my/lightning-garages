...
Config.SharedGangGarages = false 
Config.GlobalParking = true
Config.ParkingSpotSystem = true 

Config.FuelScript = 'LegacyFuel' 
Config.AllowSpawningFromAnywhere = true 
Config.ResetCars = true 
Config.WarpPlayerIntoVehicle = true
Config.ParkingDistance = 20.0 
Config.SpawnDistance = 4.5 
Config.DepotPrice = 60.0
...
Config.Garages = {
    ...
    ['impoundlot'] = {
        ['Zone'] = {
            ['Shape'] = { --polygon that surrounds the parking area
            vector2(110.30, -1047.12),
            vector2(102.57, -1063.55),
            vector2(111.30, -1067.79),
            vector2(118.87, -1049.52)
            },
            ['minZ'] = 1.25,  -- min height of the parking zone
            ['maxZ'] = 29.31,  -- max height of the parking zone
            debug = false,
        },
        label = "Çekilmiş Garaj",
        showBlip = true,
        blipcoords = vector3(109.20, -1057.38, 29.19),
        ...
        debug = false,
        ['ParkingSpots'] = {
            vector4(105.58, -1062.96, 29.19, 244.97),
            vector4(107.72, -1059.80, 29.19, 246.51),
            vector4(108.97, -1056.38, 29.19, 246.07),
            vector4(111.83, -1049.66, 29.21, 272.31)
        }
    },
    ['police'] = {
        ['Zone'] = {
